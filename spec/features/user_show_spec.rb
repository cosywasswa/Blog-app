...
before(:each) do
        ...
        @posts =[
            post1 = Post.create(author: @user1, title: 'My test post', text: 'this is a test post1', comments_counter: 0, likes_counter: 0),
            post2 = Post.create(author: @user1, title: 'My test post2', text: 'this is a test post2', comments_counter: 0, likes_counter: 0),
            post3 = Post.create(author: @user1, title: 'My test post3', text: 'this is a test post3', comments_counter: 0, likes_counter: 0)
]
